...
{!capturedPhotoUrl && photoUrl && (
  <img className={`${facingDir === 'user' ? 'thumbnail' : 'thumbnail-reverse'}`}  onClick={browsePhotos} src={photoUrl} alt="Captured Photo" />
        ...
        {capturedPhotoUrl || imageAdded ? (<img id="main__video-record" className={`${facingDir === 'user' ? 'attached-pic' : 'attached-pic-reverse'}`} style={{marginTop: '10vh'}} src={imageAdded ? imageUrl: photoUrl} />) : (
